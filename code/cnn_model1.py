...
def main(unused_argv):
  ...
  mnist_classifier = tf.estimator.Estimator(model_fn=cnn_model_fn, model_dir="/tmp/nodet_convnet_model")
  ...
  # Classifier
  nodet_classifier.train(input_fn=train_input_fn,steps=20000,hooks=[logging_hook])
