...
files = zf.ZipFile("Train_OS_Data.zip", 'r')
files.extractall('Train_OS_Data')
files.close()
files = zf.ZipFile("Test_OS_Data.zip", 'r')
files.extractall('Test_OS_Data')
files.close()
...
def main(unused_argv):
  ...
  nodet_classifier = tf.estimator.Estimator(model_fn=cnn_model_fn, model_dir="/tmp/nodet_convnet_sam1_model")
